...
<body>
    ...
    <section>
        <div class="div_header">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6 div_col_left">
                        <div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 div_col_right mt-sm-3 mt-md-0 text-md-center text-lg-end">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link actve" href="#home">HOME</a>
                        </li>
                        <li class="nav-item">
    ...
    <section>
        ...
        <section>
            <div class="div_featured pt-5 mt-5">
                <div class="container">
                    ...
                    <p class="p_left">Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore cum quas autem ab nemo cupiditate
                        dicta
                        in, qui natus. Repellat officiis modi deleniti cum eaque quae illum, vero cumque quidem! Lorem ipsum
                        dolor
                        sit amet consectetur, adipisicing elit. Minima dicta, a pariatur quo esse numquam iste eum aspernatur
                ...
                <div class="container my-5">
                    <div class="row">
                        <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                            <button class="button all" id="button1">all</button>
                        </div>
                        <div class="col-12 col-sm-6 col-md-4 col-lg-2">
            ...
            <div class="row row_width">
                <div class="col-12 col-sm-6 col-lg-3 div_images">
        ...
        <section>
            <div class="div_latest pt-5 mt-5">
                <h1>latest post</h1>
                <br>
                <p class="p_left">Lorem Ipsum Dolor Sit Amet Consectetur Adipisicing Elit. Inventore Cum Quas Autem Ab Nemo Cupiditate Dicta
        ...
        <section>
            <div class="div_flex" id="contact">
                ...
                <div class="div_left text-center text-md-start">
                    <h1>why choose us</h1>
                    <br>
            ...
            <div class="div_footer">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <h1 class="ms-5">helpful links</h1>
                            <div class="div-flex ms-2">
                                <div class="">
                                    <ul>
                                        <li>about</li>
                                        <li>protofolio</li>
                ...
                <div class="div_footer1">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 my_div my-4 my-md-0 text-center text-md-end">
